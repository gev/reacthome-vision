...
abstract class WebsocketService<
  F extends WebSocketFactory,
  E extends ConnectionEvent
>
    extends BusListener<ConnectionEvent> {
...
class LocalWebsocketService
    extends
        WebsocketService<LocalWebSocketFactory, LocalConnectRequestedEvent> {
...
class CloudWebsocketService
    extends
        WebsocketService<CloudWebSocketFactory, CloudConnectRequestedEvent> {
