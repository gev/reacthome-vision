...
import 'package:flow/ui/dto/connection_ui_dto.dart';
import 'package:flow/ui/dto/home_connection_ui_dto.dart';
...
class ConnectionViewModel<S> extends ViewModel<ConnectionEvent> {
  ...
  bool get isConnected => ConnectionUiDto(
    homeConnectionApi.getConnectionById(id).connection,
  ).isConnected;
