...
final nodeScheme = Scheme(
  ...
  items: [
    ...
    Item(id: 10, x: 9, y: 3, type: ItemType.plus),
    Item(id: 11, x: 11, y: 3, type: ItemType.device),
    Item(id: 12, x: 9, y: 5, type: ItemType.plus),
    Item(id: 13, x: 11, y: 5, type: ItemType.device),
    Item(id: 14, x: 9, y: 7, type: ItemType.plus),
    Item(id: 15, x: 11, y: 7, type: ItemType.device),
    Item(id: 16, x: 9, y: 9, type: ItemType.plus),
    Item(id: 17, x: 11, y: 9, type: ItemType.device),
    Item(id: 18, x: 9, y: 11, type: ItemType.plus),
    Item(id: 19, x: 11, y: 11, type: ItemType.device),

    Item(id: 20, x: 15, y: 3, type: ItemType.plus),
    Item(id: 21, x: 17, y: 3, type: ItemType.device),
    Item(id: 22, x: 15, y: 5, type: ItemType.plus),
    Item(id: 23, x: 17, y: 5, type: ItemType.device),
    Item(id: 24, x: 15, y: 7, type: ItemType.plus),
    Item(id: 25, x: 17, y: 7, type: ItemType.device),
    Item(id: 26, x: 15, y: 9, type: ItemType.plus),
    Item(id: 27, x: 17, y: 9, type: ItemType.device),
    Item(id: 28, x: 15, y: 11, type: ItemType.plus),
    Item(id: 29, x: 17, y: 11, type: ItemType.device),

    Item(id: 30, x: 21, y: 3, type: ItemType.plus),
    Item(id: 31, x: 23, y: 3, type: ItemType.device),
    Item(id: 32, x: 21, y: 5, type: ItemType.plus),
    Item(id: 33, x: 23, y: 5, type: ItemType.device),
    Item(id: 34, x: 21, y: 7, type: ItemType.plus),
    Item(id: 35, x: 23, y: 7, type: ItemType.device),
    Item(id: 36, x: 21, y: 9, type: ItemType.plus),
    Item(id: 37, x: 23, y: 9, type: ItemType.device),
    Item(id: 38, x: 21, y: 11, type: ItemType.plus),
    Item(id: 39, x: 23, y: 11, type: ItemType.device),

    Item(id: 40, x: 27, y: 3, type: ItemType.plus),
    Item(id: 41, x: 29, y: 3, type: ItemType.device),
    Item(id: 42, x: 27, y: 5, type: ItemType.plus),
    Item(id: 43, x: 29, y: 5, type: ItemType.device),
    Item(id: 44, x: 27, y: 7, type: ItemType.plus),
    Item(id: 45, x: 29, y: 7, type: ItemType.device),
    Item(id: 46, x: 27, y: 9, type: ItemType.plus),
    Item(id: 47, x: 29, y: 9, type: ItemType.device),
    Item(id: 48, x: 27, y: 11, type: ItemType.plus),
    Item(id: 49, x: 29, y: 11, type: ItemType.device),
  ],
  links: [
    Link(
      id: 0,
